"""Build script for phxloader_v1 pybind11 extension."""
...
ext_modules = [
    Pybind11Extension(
        "phxloader_v1._phxloader_v1",
        sources=[
            "src/phx_loader_v1.cpp",
            "src/bindings.cpp",
        ],
        include_dirs=[
...
setup(
    name="phxloader_v1",
    version="0.1.0",
    description="Phoenix DMA loader V1 for GPU Direct Storage",
    packages=["phxloader_v1"],
