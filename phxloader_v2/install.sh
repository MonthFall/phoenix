#!/usr/bin/env bash
# Convenience script to install/reinstall phxloader_v2 in conda environment.
...
# ── Install ──
echo ">>> Installing phxloader_v2 to ${CONDA_PREFIX} (no-deps, no-build-isolation)..."
...
python -P -c 'from phxloader_v2 import PhxLoaderV2; print("phxloader_v2 import OK")'
